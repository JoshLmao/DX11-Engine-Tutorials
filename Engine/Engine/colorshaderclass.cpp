...
bool ColorShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, D3DXMATRIX projectionMatrix)
{
	...
	///Set shader parameters it will use for rendering
...
bool ColorShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	if (FAILED(result))
	{
		///If shader failed to compile, it should have wrote something to the error message
		if (errorMessage)
		{
	...
	///Setup the layout of the data that goes into the shader. Needs to match the vertexType structure
...
bool ColorShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, D3DXMATRIX projectionMatrix)
{
	...
	///Copy matices into the constant buffer
	...
	///Set position of the constant buffer in vertex shader
	bufferNumber = 0;
	///Finally, set constant buffer in vertex shader with the updated values
